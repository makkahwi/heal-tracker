...
export interface serviceActivationProps {
  id: string;
...
export const initialServiceActivationState = {
  id: "x",
...
const ServicesActivation = () => {
  ...
  const [data, setData] = useState<serviceActivationProps>(
  ...
  const onSubmit = (values: serviceActivationProps) => {
    BeAPI.update({
      table: "settings",
      id: data.id || "x",
      data: values,
